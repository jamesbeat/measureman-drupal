...
(function ($) {
  ...
  Drupal.imageeditor.editors.measureman = Drupal.imageeditor.editors.measureman || {};
  Drupal.imageeditor.editors.measureman.initialize = function($imageeditor_div) {
    $imageeditor_div.find('div.measureman').not('.imageeditor-processed').addClass('imageeditor-processed').click(function(event) {
